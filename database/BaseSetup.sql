...
-- -----------------------------------------------------
-- Table `languages_countries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `languages_countries` ;

CREATE TABLE IF NOT EXISTS `languages_countries` (
...
CREATE INDEX `fk_languages_countries_languages_idx` ON `languages_countries` (`languages_id` ASC);

CREATE INDEX `fk_languages_countries_countries1_idx` ON `languages_countries` (`country_id` ASC);


-- -----------------------------------------------------
-- Table `translated_strings`
-- -----------------------------------------------------
...
CREATE INDEX `fk_translated_strings_languages1_idx` ON `translated_strings` (`language_id` ASC);

CREATE UNIQUE INDEX `content_key_UNIQUE` ON `translated_strings` (`content_key` ASC);


-- -----------------------------------------------------
-- Table `translated_contents`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `translated_contents` (
  ...
  CONSTRAINT `fk_translated_contents_translated_strings1`
    ...
    REFERENCES `translated_strings` (`translated_strings_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_translated_contents_translated_strings1_idx` ON `translated_contents` (`translated_strings_id` ASC);
...
-- -----------------------------------------------------
-- Table `projects_translated_strings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projects_translated_strings` ;

CREATE TABLE IF NOT EXISTS `projects_translated_strings` (
...
CREATE INDEX `fk_projects_translated_strings_translated_strings1_idx` ON `projects_translated_strings` (`translated_strings_translated_strings_id` ASC);
